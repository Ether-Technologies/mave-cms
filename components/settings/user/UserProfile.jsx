...
const UserProfile = () => {
    ...
    return (
      <div className="relative w-full p-6 rounded-2xl backdrop-blur-md bg-white/30 border border-white/40 shadow-lg transition-all duration-300 hover:shadow-xl hover:bg-white/40">
        <div className="flex items-center mb-2">
          <div className="w-10 h-10 rounded-full bg-gray-200/90 flex items-center justify-center mr-3">
        ...
        <div className="pl-[52px]">
          {modifyMode && isEditable ? (
            <Input
              ...
              size="large"
              className="rounded-lg border-gray-200 bg-white/50 hover:border-gray-400 focus:border-black transition-all duration-300"
            />
          ) : (
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-200 to-white p-8 animate-fadeIn">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex justify-end gap-4 mt-8">
          <Button
            ...
            icon={<LockOutlined />}
            size="large"
            className="rounded-full border-gray-300 text-black hover:border-gray-300 hover:text-gray-700 px-8 h-12 backdrop-blur-md bg-white/50"
          >
            Change Password
          </Button>
          {modifyMode ? (
            <>
              <Button
                ...
                icon={<CheckOutlined />}
                size="large"
                className="rounded-full bg-gray-200 hover:bg-gray-200 border-gray-300 px-8 h-12"
              >
                Save Changes
              </Button>
              <Button
        ...
        <Drawer
          title={
            <div className="flex items-center">
              <LockOutlined className="text-black mr-2" />
          ...
          >
            ...
            >
              <Input.Password
                ...
                className="rounded-lg border-gray-200 bg-white/50 hover:border-gray-400 focus:border-black"
              />
            </Form.Item>
