        ...
        >
            ...
            <div className="mb-6">
                <div className="flex justify-between items-center mb-3">
                    ...
                    <span className="text-2xl font-bold text-[#000000]">82%</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
                    <motion.div
                        ...
                        className="bg-gradient-to-r from-[#000000] to-[#525252] h-2 rounded-full"
                    ></motion.div>
                </div>
                <p className="text-xs text-gray-500 mt-2 flex items-center gap-1">
                    <GlobalOutlined className="text-[#000000]" />
                        ...
                        >
                            <div className="flex-1">
                                ...
                                <div className="flex items-center gap-2 mt-1">
                                    ...
                                    {item.trend !== "neutral" && (
                                        <div className={`flex items-center gap-1 text-xs ${item.trend === "up" ? "text-gray-800" : "text-gray-800"
                                            }`}>
                                            {item.trend === "up" ? (
                                                <ArrowUpOutlined />
                                            ) : (
