...
export const activityIcons = [
  {
    id: 1,
    icon: <FileFilled className="text-[1.4rem] text-[#525252]" />,
    backgroundColor: "#FFF4DC",
  },
  {
    id: 2,
    icon: <FileImageFilled className="text-[1.4rem] text-[#525252]" />,
    backgroundColor: "#FFF4DC",
  },
  {
    id: 3,
    icon: <MessageFilled className="text-[1.4rem] text-[#525252]" />,
    backgroundColor: "#FFF4DC",
  },
  {
    id: 4,
    icon: <ContactsFilled className="text-[1.4rem] text-[#525252]" />,
    backgroundColor: "#FFF4DC",
  },
];
