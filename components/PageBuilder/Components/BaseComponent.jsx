              ...
              <>
                {showChangeButton && (
                  <Button
                    icon={<ExportOutlined />}
                    onClick={onEdit}
                    className="action-button bg-blue-50 text-brand-dark border-blue-100 hover:bg-blue-100 hover:text-blue-700 hover:border-blue-200 transition-colors duration-200"
                  >
                    Change
                  </Button>
                )}
