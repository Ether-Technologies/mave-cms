                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {items.map((item, idx) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-gray-200/50 to-gray-300/50 hover:from-gray-200/50 hover:to-gray-300/50 transition-all duration-300"
                        >
                ...
                <div className="grid grid-cols-1 gap-3">
                    {items.map((item, idx) => (
                        <motion.div
                            ...
                            transition={{ delay: idx * 0.1 }}
                            viewport={{ once: true }}
                            className="p-4 rounded-xl bg-gradient-to-r from-gray-200/50 to-gray-300/50 hover:from-gray-200/50 hover:to-gray-300/50 transition-all duration-300"
                        >
