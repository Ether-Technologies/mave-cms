                                ...
                                <div className="space-y-4">
                                    {req.specs.map((spec, idx) => (
                                        <motion.div
                                            ...
                                            viewport={{ once: true }}
                                            className="flex items-center justify-between p-4 md:p-5 rounded-xl bg-gradient-to-r from-gray-200/50 to-gray-300/50 hover:from-gray-200/50 hover:to-gray-300/50 transition-all duration-300"
                                        >
                                ...
                                <div className="grid grid-cols-1 gap-4">
                                    {option.items.map((item, idx) => (
                                        <motion.div
                                            ...
                                            transition={{ delay: idx * 0.1 }}
                                            viewport={{ once: true }}
                                            className="flex items-center gap-3 p-4 md:p-5 rounded-xl bg-gradient-to-r from-gray-200/50 to-gray-300/50 hover:from-gray-200/50 hover:to-gray-300/50 transition-all duration-300"
                                        >
