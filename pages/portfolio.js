...
const Portfolio = () => {
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-300">
                {/* Hero Section */}
                <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
                    {/* Background Elements */}
                    <div className="absolute inset-0 bg-[url('/grid.svg')] bg-center [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))] opacity-10"></div>
                    <div className="absolute inset-0 bg-gradient-to-br from-gray-200/30 via-transparent to-gray-200/30"></div>
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="space-y-6"
                        >
                            <p className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-gray-200 via-gray-300 to-gray-300 bg-clip-text text-transparent">
                        ...
                        >
                            ...
                            <motion.a
                                ...
                                whileHover={{ scale: 1.05, y: -2 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-8 py-4 bg-gradient-to-r from-gray-200 to-gray-300 rounded-xl text-white hover:shadow-lg transition-all duration-300 shadow-lg hover:shadow-xl"
                            >
                                Visit Website
                            </motion.a>
                        </motion.div>
                ...
                <div className="relative py-20">
                    <div className="absolute inset-0 bg-gradient-to-b from-white via-gray-300/50 to-white"></div>
                    <div className="max-w-7xl mx-auto px-4 relative">
                        <motion.h2
                            initial={{ opacity: 0, y: 20 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            className="text-4xl font-bold bg-gradient-to-r from-gray-200 to-gray-300 bg-clip-text text-transparent text-center mb-16"
                        >
                            Powerful Features
                        </motion.h2>
